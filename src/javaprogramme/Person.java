...
public class Person {
    ...
    public static void main(String[] args) {
        ...
        person.setAge(10);
        System.out.println("fullName= " + person.getFullName()); // should return empty string
        System.out.println("teen= " + person.isTeen()); // should return false

        person.setFirstName("John"); // firstName is set to John
        person.setAge(18);
        System.out.println("fullName= " + person.getFullName()); // should return "John"
        System.out.println("teen= " + person.isTeen()); // should return true

        person.setLastName("Smith"); // lastName is set to Smith
        System.out.println("fullName= " + person.getFullName()); // should return "John Smith"
    }
}
